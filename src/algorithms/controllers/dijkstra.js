...
export default {
  ...
  run(chunker, { edgeValueMatrix, coordsMatrix, startNode, endNodes, moveNode, edgeCostType}) {
...
colors.FRONTIER_E);
          ...
          //Debugconsole.log("edgeCostType:", edgeCostType, "u:", currentVertex, "v:", m, "weight:", weight, "costToAdd:", costToAdd);
