...
const VALID_PARAM_NAMES = [
    ...
    'heuristic', 'min', 'max', 'edgeCostType'
];
...
export const withAlgorithmParams = (WrappedComponent) => {
    const WithAlgorithmParams = (props) => {
        ...
        const { alg, mode, list, value, xyCoords, edgeWeights, size, start, end, string, pattern, union, heuristic, min, max, edgeCostType} = useUrlParams();
