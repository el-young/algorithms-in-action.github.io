...
export const EXAMPLES = {
    ...
    UF_FIND                 : "Please follow the example provided: 2. The single digit should be between 1 and 10.", // TODO: coupling here, range planned to always be the the same, change to template?
